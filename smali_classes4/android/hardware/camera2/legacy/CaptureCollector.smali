...
.method public queueRequest(Landroid/hardware/camera2/legacy/RequestHolder;Landroid/hardware/camera2/legacy/LegacyRequest;JLjava/util/concurrent/TimeUnit;)Z
    ...
    .end local v4    # "h":Landroid/hardware/camera2/legacy/CaptureCollector$CaptureHolder;
    .end local v8    # "nanos":J
    .end local v10    # "lock":Ljava/util/concurrent/locks/ReentrantLock;
    .end local p0    # "this":Landroid/hardware/camera2/legacy/CaptureCollector;
    .end local p1    # "holder":Landroid/hardware/camera2/legacy/RequestHolder;
    .end local p2    # "legacy":Landroid/hardware/camera2/legacy/LegacyRequest;
    .end local p3    # "timeout":J
    .end local p5    # "unit":Ljava/util/concurrent/TimeUnit;
    throw v0

    .line 334
    .restart local v4    # "h":Landroid/hardware/camera2/legacy/CaptureCollector$CaptureHolder;
    .restart local v8    # "nanos":J
    .restart local v10    # "lock":Ljava/util/concurrent/locks/ReentrantLock;
    .restart local p0    # "this":Landroid/hardware/camera2/legacy/CaptureCollector;
    .restart local p1    # "holder":Landroid/hardware/camera2/legacy/RequestHolder;
    .restart local p2    # "legacy":Landroid/hardware/camera2/legacy/LegacyRequest;
