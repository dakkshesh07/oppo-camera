...
.method public createSession(Landroid/content/pm/PackageInstaller$SessionParams;)I
    ...
    .line 443
    .local v0, "opm":Landroid/content/pm/OplusPackageManager;
    iget v1, p0, Landroid/content/pm/PackageInstaller;->mUserId:I

    const/4 v2, 0x1

    invoke-virtual {v0, v1, v2}, Landroid/content/pm/OplusPackageManager;->prohibitChildInstallation(IZ)Z
    ...
    const-string/jumbo v2, "prevent createSession in children mode"
    ...
    .line 451
    .end local v0    # "opm":Landroid/content/pm/OplusPackageManager;
