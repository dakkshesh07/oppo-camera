...
.method public persist(Lcom/google/android/mms/pdu/GenericPdu;Landroid/net/Uri;ZZLjava/util/HashMap;)Landroid/net/Uri;
    ...
    .end local v19    # "textOnly":Z
    .local v2, "textOnly":Z
    goto :goto_e

    .line 1357
    .end local v2    # "textOnly":Z
    .restart local v19    # "textOnly":Z
    :cond_15
    move/from16 v2, v19

    .line 1364
    .end local v19    # "textOnly":Z
    .restart local v2    # "textOnly":Z
    :goto_e
    const/16 v19, 0x0
    ...
    .end local v0    # "partsNum":I
    .local v20, "partsNum":I
    ...
    .local v21, "recipients":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    ...
    .end local v20    # "partsNum":I
    .end local v21    # "recipients":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    .end local v22    # "dummyId":J
    .local v0, "partsNum":I
    .local v3, "dummyId":J
    ...
    .end local v3    # "dummyId":J
    .end local v8    # "recipients":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    .restart local v20    # "partsNum":I
    .restart local v21    # "recipients":Ljava/util/HashSet;, "Ljava/util/HashSet<Ljava/lang/String;>;"
    .restart local v22    # "dummyId":J
    move-object v2, v5
    ...
    .local v18, "res":Landroid/net/Uri;
    ...
    .end local v18    # "res":Landroid/net/Uri;
    .local v2, "body":Lcom/google/android/mms/pdu/PduBody;
    .restart local v3    # "res":Landroid/net/Uri;
    .local v15, "values":Landroid/content/ContentValues;
    .restart local v24    # "dummyId":J
    ...
    .end local v15    # "values":Landroid/content/ContentValues;
    .end local v16    # "header":Lcom/google/android/mms/pdu/PduHeaders;
