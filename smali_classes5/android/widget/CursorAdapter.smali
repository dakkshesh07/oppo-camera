...
# static fields
.field public static final whitelist test-api FLAG_AUTO_REQUERY:I = 0x1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
.end field

.field public static final whitelist test-api FLAG_REGISTER_CONTENT_OBSERVER:I = 0x2
...
# direct methods
.method public constructor whitelist test-api <init>(Landroid/content/Context;Landroid/database/Cursor;)V
    .locals 1
...
.method public constructor whitelist test-api <init>(Landroid/content/Context;Landroid/database/Cursor;I)V
    .locals 0
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "c"    # Landroid/database/Cursor;
    .param p3, "flags"    # I
...
.method public constructor whitelist test-api <init>(Landroid/content/Context;Landroid/database/Cursor;Z)V
    .locals 1
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "c"    # Landroid/database/Cursor;
...
# virtual methods
.method public abstract whitelist test-api bindView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
.end method
...
.method public whitelist test-api convertToString(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    .locals 1
    .param p1, "cursor"    # Landroid/database/Cursor;
...
.method public whitelist test-api getDropDownViewTheme()Landroid/content/res/Resources$Theme;
    .locals 1
...
.method protected whitelist test-api init(Landroid/content/Context;Landroid/database/Cursor;Z)V
    .locals 1
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "c"    # Landroid/database/Cursor;
    .param p3, "autoRequery"    # Z
...
.method public whitelist test-api newDropDownView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 1
    .param p1, "context"    # Landroid/content/Context;
...
.method public abstract whitelist test-api newView(Landroid/content/Context;Landroid/database/Cursor;Landroid/view/ViewGroup;)Landroid/view/View;
.end method

.method protected whitelist test-api onContentChanged()V
    .locals 1
...
.method public whitelist test-api setDropDownViewTheme(Landroid/content/res/Resources$Theme;)V
    .locals 2
...
.method public whitelist test-api swapCursor(Landroid/database/Cursor;)Landroid/database/Cursor;
    .locals 2
