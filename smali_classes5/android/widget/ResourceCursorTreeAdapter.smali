...
# direct methods
.method public constructor whitelist test-api <init>(Landroid/content/Context;Landroid/database/Cursor;II)V
    .locals 7
...
.method public constructor whitelist test-api <init>(Landroid/content/Context;Landroid/database/Cursor;III)V
    .locals 7
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "cursor"    # Landroid/database/Cursor;
...
.method public constructor whitelist test-api <init>(Landroid/content/Context;Landroid/database/Cursor;IIII)V
    .locals 1
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "cursor"    # Landroid/database/Cursor;
    .param p3, "collapsedGroupLayout"    # I
...
# virtual methods
.method public whitelist test-api newChildView(Landroid/content/Context;Landroid/database/Cursor;ZLandroid/view/ViewGroup;)Landroid/view/View;
    .locals 3
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "cursor"    # Landroid/database/Cursor;
...
.method public whitelist test-api newGroupView(Landroid/content/Context;Landroid/database/Cursor;ZLandroid/view/ViewGroup;)Landroid/view/View;
    .locals 3
    .param p1, "context"    # Landroid/content/Context;
    .param p2, "cursor"    # Landroid/database/Cursor;
