...
# direct methods
.method public constructor whitelist test-api <init>(Landroid/database/Cursor;Landroid/content/Context;)V
    .locals 1
...
.method public constructor whitelist test-api <init>(Landroid/database/Cursor;Landroid/content/Context;Z)V
    .locals 0
    .param p1, "cursor"    # Landroid/database/Cursor;
    .param p2, "context"    # Landroid/content/Context;
...
# virtual methods
.method protected abstract whitelist test-api bindChildView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;Z)V
.end method

.method protected abstract whitelist test-api bindGroupView(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;Z)V
.end method

.method public whitelist test-api changeCursor(Landroid/database/Cursor;)V
    .locals 2
    .param p1, "cursor"    # Landroid/database/Cursor;
...
.method public whitelist test-api convertToString(Landroid/database/Cursor;)Ljava/lang/String;
    .locals 1
    .param p1, "cursor"    # Landroid/database/Cursor;
...
.method public whitelist test-api getChild(II)Landroid/database/Cursor;
    .locals 1
    .param p1, "groupPosition"    # I
...
.method public bridge synthetic whitelist test-api getChild(II)Ljava/lang/Object;
    .locals 0
...
.method public whitelist test-api getChildId(II)J
    .locals 2
    .param p1, "groupPosition"    # I
    .param p2, "childPosition"    # I
...
.method public whitelist test-api getChildView(IIZLandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 4
    .param p1, "groupPosition"    # I
    .param p2, "childPosition"    # I
...
.method public whitelist test-api getChildrenCount(I)I
    .locals 2
    .param p1, "groupPosition"    # I
...
.method protected abstract whitelist test-api getChildrenCursor(Landroid/database/Cursor;)Landroid/database/Cursor;
.end method
...
.method public whitelist test-api getFilterQueryProvider()Landroid/widget/FilterQueryProvider;
    .locals 1
...
.method public whitelist test-api getGroup(I)Landroid/database/Cursor;
    .locals 1
    .param p1, "groupPosition"    # I
...
.method public bridge synthetic whitelist test-api getGroup(I)Ljava/lang/Object;
    .locals 0
...
.method public whitelist test-api getGroupCount()I
    .locals 1
...
.method public whitelist test-api getGroupId(I)J
    .locals 2
    .param p1, "groupPosition"    # I
...
.method public whitelist test-api getGroupView(IZLandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    .locals 3
    .param p1, "groupPosition"    # I
...
.method public whitelist test-api isChildSelectable(II)Z
    .locals 1
    .param p1, "groupPosition"    # I
    .param p2, "childPosition"    # I
...
.method protected abstract whitelist test-api newChildView(Landroid/content/Context;Landroid/database/Cursor;ZLandroid/view/ViewGroup;)Landroid/view/View;
.end method

.method protected abstract whitelist test-api newGroupView(Landroid/content/Context;Landroid/database/Cursor;ZLandroid/view/ViewGroup;)Landroid/view/View;
.end method
...
.method public whitelist test-api notifyDataSetChanged(Z)V
    .locals 0
...
.method public whitelist test-api onGroupCollapsed(I)V
    .locals 0
    .param p1, "groupPosition"    # I
...
.method public whitelist test-api runQueryOnBackgroundThread(Ljava/lang/CharSequence;)Landroid/database/Cursor;
    .locals 1
...
.method public whitelist test-api setChildrenCursor(ILandroid/database/Cursor;)V
    .locals 2
    .param p1, "groupPosition"    # I
...
.method public whitelist test-api setFilterQueryProvider(Landroid/widget/FilterQueryProvider;)V
    .locals 0
...
.method public whitelist test-api setGroupCursor(Landroid/database/Cursor;)V
    .locals 2
    .param p1, "cursor"    # Landroid/database/Cursor;
