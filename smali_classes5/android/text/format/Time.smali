...
.field public static final whitelist test-api EPOCH_JULIAN_DAY:I = 0x253d8c

.field public static final whitelist test-api FRIDAY:I = 0x5

.field public static final whitelist test-api HOUR:I = 0x3

.field public static final whitelist test-api MINUTE:I = 0x2

.field public static final whitelist test-api MONDAY:I = 0x1

.field public static final whitelist test-api MONDAY_BEFORE_JULIAN_EPOCH:I = 0x253d89

.field public static final whitelist test-api MONTH:I = 0x5

.field public static final whitelist test-api MONTH_DAY:I = 0x4

.field public static final whitelist test-api SATURDAY:I = 0x6

.field public static final whitelist test-api SECOND:I = 0x1

.field public static final whitelist test-api SUNDAY:I = 0x0

.field public static final whitelist test-api THURSDAY:I = 0x4

.field public static final whitelist test-api TIMEZONE_UTC:Ljava/lang/String; = "UTC"

.field public static final whitelist test-api TUESDAY:I = 0x2

.field public static final whitelist test-api WEDNESDAY:I = 0x3

.field public static final whitelist test-api WEEK_DAY:I = 0x7

.field public static final whitelist test-api WEEK_NUM:I = 0x9

.field public static final whitelist test-api YEAR:I = 0x6

.field public static final whitelist test-api YEAR_DAY:I = 0x8
...
# instance fields
.field public whitelist test-api allDay:Z

.field private greylist-max-o calculator:Landroid/text/format/Time$TimeCalculator;

.field public whitelist test-api gmtoff:J

.field public whitelist test-api hour:I

.field public whitelist test-api isDst:I

.field public whitelist test-api minute:I

.field public whitelist test-api month:I

.field public whitelist test-api monthDay:I

.field public whitelist test-api second:I

.field public whitelist test-api timezone:Ljava/lang/String;

.field public whitelist test-api weekDay:I

.field public whitelist test-api year:I

.field public whitelist test-api yearDay:I
...
.method public constructor whitelist test-api <init>(Landroid/text/format/Time;)V
    .locals 1
...
.method public static whitelist test-api compare(Landroid/text/format/Time;Landroid/text/format/Time;)I
    .locals 2
...
.method public static whitelist test-api getCurrentTimezone()Ljava/lang/String;
    .locals 1
...
.method public static whitelist test-api getJulianDay(JJ)I
    .locals 11
    .param p0, "millis"    # J
...
.method public static whitelist test-api getJulianMondayFromWeeksSinceEpoch(I)I
    .locals 2
    .param p0, "week"    # I
...
.method public static whitelist test-api getWeeksSinceEpochFromJulianDay(II)I
    .locals 3
...
.method public static whitelist test-api isEpoch(Landroid/text/format/Time;)Z
    .locals 5
...
# virtual methods
.method public whitelist test-api after(Landroid/text/format/Time;)Z
    .locals 1
...
.method public whitelist test-api before(Landroid/text/format/Time;)Z
    .locals 1
    .param p1, "that"    # Landroid/text/format/Time;
...
.method public whitelist test-api clear(Ljava/lang/String;)V
    .locals 2
    .param p1, "timezoneId"    # Ljava/lang/String;
...
.method public whitelist test-api format(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method public whitelist test-api format2445()Ljava/lang/String;
    .locals 2
...
.method public whitelist test-api format3339(Z)Ljava/lang/String;
    .locals 9
    .param p1, "allDay"    # Z
...
.method public whitelist test-api getWeekNumber()I
    .locals 6
...
.method public whitelist test-api normalize(Z)J
    .locals 3
...
.method public whitelist test-api parse(Ljava/lang/String;)Z
    .locals 2
    .param p1, "s"    # Ljava/lang/String;
...
.method public whitelist test-api parse3339(Ljava/lang/String;)Z
    .locals 2
    .param p1, "s"    # Ljava/lang/String;
...
.method public whitelist test-api set(III)V
    .locals 2
    .param p1, "monthDay"    # I
    .param p2, "month"    # I
    .param p3, "year"    # I
...
.method public whitelist test-api set(IIIIII)V
    .locals 2
    .param p1, "second"    # I
    .param p2, "minute"    # I
    .param p3, "hour"    # I
...
.method public whitelist test-api set(J)V
    .locals 2
    .param p1, "millis"    # J
...
.method public whitelist test-api set(Landroid/text/format/Time;)V
    .locals 2
    .param p1, "that"    # Landroid/text/format/Time;
...
.method public whitelist test-api setJulianDay(I)J
    .locals 5
...
.method public whitelist test-api setToNow()V
    .locals 2
...
.method public whitelist test-api switchTimezone(Ljava/lang/String;)V
    .locals 1
...
.method public whitelist test-api toMillis(Z)J
    .locals 2
    .param p1, "ignoreDst"    # Z
