...
.method public constructor whitelist test-api <init>(Ljava/util/Locale;ZZ)V
    .locals 12
    .param p1, "locale"    # Ljava/util/Locale;
    .param p2, "sign"    # Z
    .param p3, "decimal"    # Z
...
.method public constructor whitelist test-api <init>(ZZ)V
    .locals 1
    .param p1, "sign"    # Z
    .param p2, "decimal"    # Z
    .annotation runtime Ljava/lang/Deprecated;
...
.method public static whitelist test-api getInstance()Landroid/text/method/DigitsKeyListener;
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public static whitelist test-api getInstance(Ljava/lang/String;)Landroid/text/method/DigitsKeyListener;
    .locals 3
...
.method public static whitelist test-api getInstance(Ljava/util/Locale;)Landroid/text/method/DigitsKeyListener;
    .locals 1
...
.method public static whitelist test-api getInstance(Ljava/util/Locale;ZZ)Landroid/text/method/DigitsKeyListener;
    .locals 4
    .param p0, "locale"    # Ljava/util/Locale;
    .param p1, "sign"    # Z
    .param p2, "decimal"    # Z
...
.method public static whitelist test-api getInstance(ZZ)Landroid/text/method/DigitsKeyListener;
    .locals 1
    .param p0, "sign"    # Z
    .param p1, "decimal"    # Z
    .annotation runtime Ljava/lang/Deprecated;
