...
.field public static final whitelist test-api META_ALT_LOCKED:I = 0x200
...
.field public static final whitelist test-api META_CAP_LOCKED:I = 0x100
...
.field public static final whitelist test-api META_SYM_LOCKED:I = 0x400
...
.method public static whitelist test-api adjustMetaAfterKeypress(J)J
    .locals 6
    .param p0, "state"    # J
...
.method public static whitelist test-api adjustMetaAfterKeypress(Landroid/text/Spannable;)V
    .locals 1
    .param p0, "content"    # Landroid/text/Spannable;
...
.method public static whitelist test-api clearMetaKeyState(Landroid/text/Editable;I)V
    .locals 1
...
.method public static final whitelist test-api getMetaState(J)I
    .locals 5
    .param p0, "state"    # J
...
.method public static final whitelist test-api getMetaState(JI)I
    .locals 7
    .param p0, "state"    # J
    .param p2, "meta"    # I
...
.method public static final whitelist test-api getMetaState(Ljava/lang/CharSequence;)I
    .locals 4
    .param p0, "text"    # Ljava/lang/CharSequence;
...
.method public static final whitelist test-api getMetaState(Ljava/lang/CharSequence;I)I
    .locals 3
    .param p0, "text"    # Ljava/lang/CharSequence;
    .param p1, "meta"    # I
...
.method public static final whitelist test-api getMetaState(Ljava/lang/CharSequence;ILandroid/view/KeyEvent;)I
    .locals 3
    .param p0, "text"    # Ljava/lang/CharSequence;
    .param p1, "meta"    # I
...
.method public static final whitelist test-api getMetaState(Ljava/lang/CharSequence;Landroid/view/KeyEvent;)I
    .locals 3
    .param p0, "text"    # Ljava/lang/CharSequence;
...
.method public static whitelist test-api handleKeyDown(JILandroid/view/KeyEvent;)J
    .locals 16
    .param p0, "state"    # J
    .param p2, "keyCode"    # I
...
.method public static whitelist test-api handleKeyUp(JILandroid/view/KeyEvent;)J
    .locals 15
    .param p0, "state"    # J
    .param p2, "keyCode"    # I
    .param p3, "event"    # Landroid/view/KeyEvent;
...
.method public static whitelist test-api isMetaTracker(Ljava/lang/CharSequence;Ljava/lang/Object;)Z
    .locals 1
    .param p0, "text"    # Ljava/lang/CharSequence;
    .param p1, "what"    # Ljava/lang/Object;
...
.method public static whitelist test-api isSelectingMetaTracker(Ljava/lang/CharSequence;Ljava/lang/Object;)Z
    .locals 1
    .param p0, "text"    # Ljava/lang/CharSequence;
    .param p1, "what"    # Ljava/lang/Object;
...
.method public static whitelist test-api resetLockedMeta(J)J
    .locals 4
    .param p0, "state"    # J
...
.method protected static whitelist test-api resetLockedMeta(Landroid/text/Spannable;)V
    .locals 1
    .param p0, "content"    # Landroid/text/Spannable;
...
.method public static whitelist test-api resetMetaState(Landroid/text/Spannable;)V
    .locals 1
...
# virtual methods
.method public whitelist test-api clearMetaKeyState(JI)J
    .locals 5
    .param p1, "state"    # J
    .param p3, "which"    # I
...
.method public whitelist test-api clearMetaKeyState(Landroid/view/View;Landroid/text/Editable;I)V
    .locals 0
...
.method public whitelist test-api onKeyDown(Landroid/view/View;Landroid/text/Editable;ILandroid/view/KeyEvent;)Z
    .locals 2
    .param p1, "view"    # Landroid/view/View;
    .param p2, "content"    # Landroid/text/Editable;
    .param p3, "keyCode"    # I
...
.method public whitelist test-api onKeyUp(Landroid/view/View;Landroid/text/Editable;ILandroid/view/KeyEvent;)Z
    .locals 2
    .param p1, "view"    # Landroid/view/View;
    .param p2, "content"    # Landroid/text/Editable;
    .param p3, "keyCode"    # I
