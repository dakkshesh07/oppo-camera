...
# static fields
.field public static final whitelist test-api ORDER_NORMAL:I = 0x0

.field public static final whitelist test-api ORDER_RANDOM:I = 0x2

.field public static final whitelist test-api ORDER_REVERSE:I = 0x1


# instance fields
.field protected whitelist test-api mAnimation:Landroid/view/animation/Animation;

.field private greylist-max-o mDelay:F

.field private greylist-max-o mDuration:J

.field protected whitelist test-api mInterpolator:Landroid/view/animation/Interpolator;

.field private greylist-max-o mMaxDelay:J

.field private greylist-max-o mOrder:I

.field protected whitelist test-api mRandomizer:Ljava/util/Random;
...
.method public constructor whitelist test-api <init>(Landroid/view/animation/Animation;)V
    .locals 1
...
.method public constructor whitelist test-api <init>(Landroid/view/animation/Animation;F)V
    .locals 0
    .param p1, "animation"    # Landroid/view/animation/Animation;
    .param p2, "delay"    # F
...
# virtual methods
.method public whitelist test-api getAnimation()Landroid/view/animation/Animation;
    .locals 1
...
.method public final whitelist test-api getAnimationForView(Landroid/view/View;)Landroid/view/animation/Animation;
    .locals 4
...
.method public whitelist test-api getDelay()F
    .locals 1
...
.method protected whitelist test-api getDelayForView(Landroid/view/View;)J
    .locals 9
    .param p1, "view"    # Landroid/view/View;
...
.method protected whitelist test-api getTransformedIndex(Landroid/view/animation/LayoutAnimationController$AnimationParameters;)I
    .locals 2
...
.method public whitelist test-api setAnimation(Landroid/content/Context;I)V
    .locals 1
    .param p1, "context"    # Landroid/content/Context;
...
.method public whitelist test-api setAnimation(Landroid/view/animation/Animation;)V
    .locals 1
    .param p1, "animation"    # Landroid/view/animation/Animation;
...
.method public whitelist test-api setDelay(F)V
    .locals 0
    .param p1, "delay"    # F
...
.method public whitelist test-api willOverlap()Z
    .locals 2
