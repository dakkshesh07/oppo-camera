...
# static fields
.field public static final whitelist test-api ERROR_DESTINATION_INVALID:I = 0x5

.field public static final whitelist test-api ERROR_SOURCE_INVALID:I = 0x4

.field public static final whitelist test-api ERROR_SOURCE_NO_DATA:I = 0x3

.field public static final whitelist test-api ERROR_TIMEOUT:I = 0x2

.field public static final whitelist test-api ERROR_UNKNOWN:I = 0x1

.field public static final whitelist test-api SUCCESS:I
...
.method public static whitelist test-api request(Landroid/view/Surface;Landroid/graphics/Bitmap;Landroid/view/PixelCopy$OnPixelCopyFinishedListener;Landroid/os/Handler;)V
    .locals 1
...
.method public static whitelist test-api request(Landroid/view/Surface;Landroid/graphics/Rect;Landroid/graphics/Bitmap;Landroid/view/PixelCopy$OnPixelCopyFinishedListener;Landroid/os/Handler;)V
    .locals 2
    .param p0, "source"    # Landroid/view/Surface;
...
.method public static whitelist test-api request(Landroid/view/SurfaceView;Landroid/graphics/Bitmap;Landroid/view/PixelCopy$OnPixelCopyFinishedListener;Landroid/os/Handler;)V
    .locals 1
...
.method public static whitelist test-api request(Landroid/view/SurfaceView;Landroid/graphics/Rect;Landroid/graphics/Bitmap;Landroid/view/PixelCopy$OnPixelCopyFinishedListener;Landroid/os/Handler;)V
    .locals 1
    .param p0, "source"    # Landroid/view/SurfaceView;
    .param p1, "srcRect"    # Landroid/graphics/Rect;
    .param p2, "dest"    # Landroid/graphics/Bitmap;
...
.method public static whitelist test-api request(Landroid/view/Window;Landroid/graphics/Bitmap;Landroid/view/PixelCopy$OnPixelCopyFinishedListener;Landroid/os/Handler;)V
    .locals 1
...
.method public static whitelist test-api request(Landroid/view/Window;Landroid/graphics/Rect;Landroid/graphics/Bitmap;Landroid/view/PixelCopy$OnPixelCopyFinishedListener;Landroid/os/Handler;)V
    .locals 9
    .param p0, "source"    # Landroid/view/Window;
    .param p1, "srcRect"    # Landroid/graphics/Rect;
    .param p2, "dest"    # Landroid/graphics/Bitmap;
