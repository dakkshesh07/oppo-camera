...
.method public blacklist createFromParcel(Landroid/os/Parcel;)Landroid/telecom/ParcelableCall;
    ...
    .local v14, "conferenceableCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .end local v14    # "conferenceableCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .restart local v25    # "conferenceableCallIds":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .local v26, "intentExtras":Landroid/os/Bundle;
    invoke-virtual {v0, v1}, Landroid/os/Parcel;->readBundle(Ljava/lang/ClassLoader;)Landroid/os/Bundle;
    ...
    .end local v15    # "isVideoCallProviderChanged":Z
    .local v28, "isVideoCallProviderChanged":Z
    invoke-virtual/range {p1 .. p1}, Landroid/os/Parcel;->readByte()B
    ...
    .end local v28    # "isVideoCallProviderChanged":Z
    ...
    .restart local v28    # "isVideoCallProviderChanged":Z
    ...
    .end local v26    # "intentExtras":Landroid/os/Bundle;
    ...
    .restart local v26    # "intentExtras":Landroid/os/Bundle;
