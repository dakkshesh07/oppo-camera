...
.field public static final whitelist test-api CRLF:I = 0x4

.field public static final whitelist test-api DEFAULT:I = 0x0

.field public static final whitelist test-api NO_CLOSE:I = 0x10

.field public static final whitelist test-api NO_PADDING:I = 0x1

.field public static final whitelist test-api NO_WRAP:I = 0x2

.field public static final whitelist test-api URL_SAFE:I = 0x8
...
.method public static whitelist test-api decode(Ljava/lang/String;I)[B
    .locals 1
...
.method public static whitelist test-api decode([BI)[B
    .locals 2
    .param p0, "input"    # [B
    .param p1, "flags"    # I
...
.method public static whitelist test-api decode([BIII)[B
    .locals 5
    .param p0, "input"    # [B
    .param p1, "offset"    # I
    .param p2, "len"    # I
...
.method public static whitelist test-api encode([BI)[B
    .locals 2
    .param p0, "input"    # [B
    .param p1, "flags"    # I
...
.method public static whitelist test-api encode([BIII)[B
    .locals 6
    .param p0, "input"    # [B
    .param p1, "offset"    # I
    .param p2, "len"    # I
...
.method public static whitelist test-api encodeToString([BI)Ljava/lang/String;
    .locals 3
    .param p0, "input"    # [B
    .param p1, "flags"    # I
...
.method public static whitelist test-api encodeToString([BIII)Ljava/lang/String;
    .locals 3
    .param p0, "input"    # [B
    .param p1, "offset"    # I
    .param p2, "len"    # I
