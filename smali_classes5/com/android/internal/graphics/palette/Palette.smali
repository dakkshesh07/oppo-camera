...
.field static final blacklist LOG_TIMINGS:Z = false

.field static final blacklist MIN_CONTRAST_BODY_TEXT:F = 4.5f

.field static final blacklist MIN_CONTRAST_TITLE_TEXT:F = 3.0f


# instance fields
.field private final blacklist mDominantSwatch:Lcom/android/internal/graphics/palette/Palette$Swatch;

.field private final blacklist mSelectedSwatches:Ljava/util/Map;
...
.field private final blacklist mUsedColors:Landroid/util/SparseBooleanArray;
...
.method private static blacklist copyHslValues(Lcom/android/internal/graphics/palette/Palette$Swatch;)[F
    .locals 4
...
.method public static blacklist from(Landroid/graphics/Bitmap;)Lcom/android/internal/graphics/palette/Palette$Builder;
    .locals 1
...
.method public static blacklist generate(Landroid/graphics/Bitmap;)Lcom/android/internal/graphics/palette/Palette;
    .locals 1
    .param p0, "bitmap"    # Landroid/graphics/Bitmap;
...
.method public static blacklist generate(Landroid/graphics/Bitmap;I)Lcom/android/internal/graphics/palette/Palette;
    .locals 1
    .param p0, "bitmap"    # Landroid/graphics/Bitmap;
...
.method public static blacklist generateAsync(Landroid/graphics/Bitmap;ILcom/android/internal/graphics/palette/Palette$PaletteAsyncListener;)Landroid/os/AsyncTask;
    .locals 1
    .param p0, "bitmap"    # Landroid/graphics/Bitmap;
    .param p1, "numColors"    # I
...
.method public static blacklist generateAsync(Landroid/graphics/Bitmap;Lcom/android/internal/graphics/palette/Palette$PaletteAsyncListener;)Landroid/os/AsyncTask;
    .locals 1
    .param p0, "bitmap"    # Landroid/graphics/Bitmap;
...
.method private blacklist generateScore(Lcom/android/internal/graphics/palette/Palette$Swatch;Lcom/android/internal/graphics/palette/Target;)F
    .locals 10
...
.method private blacklist generateScoredTarget(Lcom/android/internal/graphics/palette/Target;)Lcom/android/internal/graphics/palette/Palette$Swatch;
    .locals 4
...
.method private blacklist getMaxScoredSwatchForTarget(Lcom/android/internal/graphics/palette/Target;)Lcom/android/internal/graphics/palette/Palette$Swatch;
    .locals 7
    .param p1, "target"    # Lcom/android/internal/graphics/palette/Target;
...
.method private blacklist shouldBeScoredForTarget(Lcom/android/internal/graphics/palette/Palette$Swatch;Lcom/android/internal/graphics/palette/Target;)Z
    .locals 5
    .param p1, "swatch"    # Lcom/android/internal/graphics/palette/Palette$Swatch;
    .param p2, "target"    # Lcom/android/internal/graphics/palette/Target;
...
.method public blacklist getColorForTarget(Lcom/android/internal/graphics/palette/Target;I)I
    .locals 2
    .param p1, "target"    # Lcom/android/internal/graphics/palette/Target;
...
.method public blacklist getDarkMutedSwatch()Lcom/android/internal/graphics/palette/Palette$Swatch;
    .locals 1
...
.method public blacklist getDarkVibrantSwatch()Lcom/android/internal/graphics/palette/Palette$Swatch;
    .locals 1
...
.method public blacklist getDominantColor(I)I
    .locals 1
    .param p1, "defaultColor"    # I
...
.method public blacklist getLightMutedSwatch()Lcom/android/internal/graphics/palette/Palette$Swatch;
    .locals 1
...
.method public blacklist getLightVibrantSwatch()Lcom/android/internal/graphics/palette/Palette$Swatch;
    .locals 1
...
.method public blacklist getMutedSwatch()Lcom/android/internal/graphics/palette/Palette$Swatch;
    .locals 1
...
.method public blacklist getSwatchForTarget(Lcom/android/internal/graphics/palette/Target;)Lcom/android/internal/graphics/palette/Palette$Swatch;
    .locals 1
    .param p1, "target"    # Lcom/android/internal/graphics/palette/Target;
...
.method public blacklist getVibrantSwatch()Lcom/android/internal/graphics/palette/Palette$Swatch;
    .locals 1
