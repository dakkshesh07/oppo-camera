...
# instance fields
.field private greylist mAlpnProtocols:[B

.field private greylist mChannelIdPrivateKey:Ljava/security/PrivateKey;
...
.field private greylist mKeyManagers:[Ljavax/net/ssl/KeyManager;

.field private greylist mNpnProtocols:[B

.field private final greylist mSecure:Z

.field private greylist mSecureFactory:Ljavax/net/ssl/SSLSocketFactory;

.field private final greylist mSessionCache:Lcom/android/org/conscrypt/SSLClientSessionCache;

.field private greylist mTrustManagers:[Ljavax/net/ssl/TrustManager;
...
.method private static greylist castToOpenSSLSocket(Ljava/net/Socket;)Lcom/android/org/conscrypt/OpenSSLSocketImpl;
    .locals 3
...
.method public static whitelist test-api getDefault(I)Ljavax/net/SocketFactory;
    .locals 3
...
.method public static whitelist test-api getDefault(ILandroid/net/SSLSessionCache;)Ljavax/net/ssl/SSLSocketFactory;
    .locals 2
    .param p0, "handshakeTimeoutMillis"    # I
...
.method public static whitelist test-api getInsecure(ILandroid/net/SSLSessionCache;)Ljavax/net/ssl/SSLSocketFactory;
    .locals 2
    .param p0, "handshakeTimeoutMillis"    # I
    .param p1, "cache"    # Landroid/net/SSLSessionCache;
...
.method private greylist makeSocketFactory([Ljavax/net/ssl/KeyManager;[Ljavax/net/ssl/TrustManager;)Ljavax/net/ssl/SSLSocketFactory;
    .locals 3
...
.method public whitelist test-api getNpnSelectedProtocol(Ljava/net/Socket;)[B
    .locals 1
    .param p1, "socket"    # Ljava/net/Socket;
...
.method public greylist setAlpnProtocols([[B)V
    .locals 1
...
.method public whitelist test-api setHostname(Ljava/net/Socket;Ljava/lang/String;)V
    .locals 1
    .param p1, "socket"    # Ljava/net/Socket;
...
.method public whitelist test-api setKeyManagers([Ljavax/net/ssl/KeyManager;)V
    .locals 1
    .param p1, "keyManagers"    # [Ljavax/net/ssl/KeyManager;
...
.method public whitelist test-api setNpnProtocols([[B)V
    .locals 1
...
.method public greylist setSoWriteTimeout(Ljava/net/Socket;I)V
    .locals 1
    .param p1, "socket"    # Ljava/net/Socket;
...
.method public whitelist test-api setTrustManagers([Ljavax/net/ssl/TrustManager;)V
    .locals 1
...
.method public whitelist test-api setUseSessionTickets(Ljava/net/Socket;Z)V
    .locals 1
    .param p1, "socket"    # Ljava/net/Socket;
