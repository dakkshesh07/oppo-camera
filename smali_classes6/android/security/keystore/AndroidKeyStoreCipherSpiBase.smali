...
# instance fields
.field private greylist-max-o mAdditionalAuthenticationDataStreamer:Landroid/security/keystore/KeyStoreCryptoOperationStreamer;

.field private greylist-max-o mAdditionalAuthenticationDataStreamerClosed:Z

.field private greylist-max-o mCachedException:Ljava/lang/Exception;

.field private greylist-max-o mEncrypting:Z

.field private greylist-max-o mKey:Landroid/security/keystore/AndroidKeyStoreKey;

.field private final greylist-max-o mKeyStore:Landroid/security/KeyStore;

.field private greylist-max-o mKeymasterPurposeOverride:I

.field private greylist-max-o mMainDataStreamer:Landroid/security/keystore/KeyStoreCryptoOperationStreamer;

.field private greylist-max-o mOperationHandle:J

.field private greylist-max-o mOperationToken:Landroid/os/IBinder;
...
.method private greylist-max-o ensureKeystoreOperationInitialized()V
    .locals 11
...
.method private greylist-max-o flushAAD()V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method private greylist-max-o init(ILjava/security/Key;Ljava/security/SecureRandom;)V
    .locals 3
    .param p1, "opmode"    # I
...
.method static greylist-max-o opmodeToString(I)Ljava/lang/String;
    .locals 1
    .param p0, "opmode"    # I
...
# virtual methods
.method protected abstract greylist-max-o addAlgorithmSpecificParametersToBegin(Landroid/security/keymaster/KeymasterArguments;)V
.end method

.method protected greylist-max-o createAdditionalAuthenticationDataStreamer(Landroid/security/KeyStore;Landroid/os/IBinder;)Landroid/security/keystore/KeyStoreCryptoOperationStreamer;
    .locals 1
...
.method protected greylist-max-o createMainDataStreamer(Landroid/security/KeyStore;Landroid/os/IBinder;)Landroid/security/keystore/KeyStoreCryptoOperationStreamer;
    .locals 3
    .param p1, "keyStore"    # Landroid/security/KeyStore;
    .param p2, "operationToken"    # Landroid/os/IBinder;
...
.method protected final whitelist core-platform-api test-api engineDoFinal(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)I
    .locals 8
...
.method protected final whitelist core-platform-api test-api engineDoFinal([BII[BI)I
    .locals 5
    .param p1, "input"    # [B
...
.method protected final whitelist core-platform-api test-api engineDoFinal([BII)[B
    .locals 8
    .param p1, "input"    # [B
    .param p2, "inputOffset"    # I
    .param p3, "inputLen"    # I
...
.method protected final whitelist core-platform-api test-api engineGetKeySize(Ljava/security/Key;)I
    .locals 1
...
.method protected abstract whitelist core-platform-api test-api engineGetParameters()Ljava/security/AlgorithmParameters;
.end method

.method protected final whitelist core-platform-api test-api engineInit(ILjava/security/Key;Ljava/security/AlgorithmParameters;Ljava/security/SecureRandom;)V
    .locals 2
    .param p1, "opmode"    # I
    .param p2, "key"    # Ljava/security/Key;
...
.method protected final whitelist core-platform-api test-api engineInit(ILjava/security/Key;Ljava/security/SecureRandom;)V
    .locals 3
    .param p1, "opmode"    # I
    .param p2, "key"    # Ljava/security/Key;
    .param p3, "random"    # Ljava/security/SecureRandom;
    ...
    .end local p0    # "this":Landroid/security/keystore/AndroidKeyStoreCipherSpiBase;
    ...
    .restart local p0    # "this":Landroid/security/keystore/AndroidKeyStoreCipherSpiBase;
...
.method protected final whitelist core-platform-api test-api engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    .locals 2
    .param p1, "opmode"    # I
    .param p2, "key"    # Ljava/security/Key;
...
.method protected final whitelist core-platform-api test-api engineSetMode(Ljava/lang/String;)V
    .locals 1
...
.method protected final whitelist core-platform-api test-api engineSetPadding(Ljava/lang/String;)V
    .locals 1
...
.method protected final whitelist core-platform-api test-api engineUnwrap([BLjava/lang/String;I)Ljava/security/Key;
    .locals 5
...
.method protected final whitelist core-platform-api test-api engineUpdate(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;)I
    .locals 8
    .param p1, "input"    # Ljava/nio/ByteBuffer;
    .param p2, "output"    # Ljava/nio/ByteBuffer;
    .annotation system Ldalvik/annotation/Throws;
...
.method protected final whitelist core-platform-api test-api engineUpdate([BII[BI)I
    .locals 5
    .param p1, "input"    # [B
    .param p2, "inputOffset"    # I
    .param p3, "inputLen"    # I
...
.method protected final whitelist core-platform-api test-api engineUpdate([BII)[B
    .locals 3
    .param p1, "input"    # [B
    .param p2, "inputOffset"    # I
    .param p3, "inputLen"    # I
...
.method protected final whitelist core-platform-api test-api engineUpdateAAD(Ljava/nio/ByteBuffer;)V
    .locals 4
...
.method protected final whitelist core-platform-api test-api engineUpdateAAD([BII)V
    .locals 4
    .param p1, "input"    # [B
    .param p2, "inputOffset"    # I
    .param p3, "inputLen"    # I
...
.method protected final whitelist core-platform-api test-api engineWrap(Ljava/security/Key;)[B
    .locals 5
    .param p1, "key"    # Ljava/security/Key;
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method protected abstract greylist-max-o getAdditionalEntropyAmountForBegin()I
.end method

.method protected abstract greylist-max-o getAdditionalEntropyAmountForFinish()I
.end method

.method protected final greylist-max-o getConsumedInputSizeBytes()J
    .locals 2
...
.method protected final greylist-max-o getKeyStore()Landroid/security/KeyStore;
    .locals 1
...
.method protected final greylist-max-o getKeymasterPurposeOverride()I
    .locals 1
...
.method public final greylist-max-o getOperationHandle()J
    .locals 2
...
.method protected final greylist-max-o getProducedOutputSizeBytes()J
    .locals 2
...
.method protected abstract greylist-max-o initAlgorithmSpecificParameters()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/InvalidKeyException;
        }
...
.method protected abstract greylist-max-o initAlgorithmSpecificParameters(Ljava/security/AlgorithmParameters;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/InvalidAlgorithmParameterException;
        }
...
.method protected abstract greylist-max-o initAlgorithmSpecificParameters(Ljava/security/spec/AlgorithmParameterSpec;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/InvalidAlgorithmParameterException;
        }
...
.method protected abstract greylist-max-o initKey(ILjava/security/Key;)V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/InvalidKeyException;
        }
...
.method protected final greylist-max-o isEncrypting()Z
    .locals 1
...
.method protected abstract greylist-max-o loadAlgorithmSpecificParametersFromBeginResult(Landroid/security/keymaster/KeymasterArguments;)V
.end method

.method protected greylist-max-o resetAll()V
    .locals 5
...
.method protected greylist-max-o resetWhilePreservingInitState()V
    .locals 4
...
.method protected final greylist-max-o setKey(Landroid/security/keystore/AndroidKeyStoreKey;)V
    .locals 0
...
.method protected final greylist-max-o setKeymasterPurposeOverride(I)V
    .locals 0
