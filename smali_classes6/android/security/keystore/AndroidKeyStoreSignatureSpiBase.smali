...
.field private blacklist mKey:Landroid/security/keystore/AndroidKeyStoreKey;

.field private final blacklist mKeyStore:Landroid/security/KeyStore;

.field private blacklist mMessageStreamer:Landroid/security/keystore/KeyStoreCryptoOperationStreamer;

.field private blacklist mOperationHandle:J

.field private blacklist mOperationToken:Landroid/os/IBinder;
...
# virtual methods
.method protected abstract blacklist addAlgorithmSpecificParametersToBegin(Landroid/security/keymaster/KeymasterArguments;)V
.end method

.method protected blacklist createMainDataStreamer(Landroid/security/KeyStore;Landroid/os/IBinder;)Landroid/security/keystore/KeyStoreCryptoOperationStreamer;
    .locals 2
...
.method protected final whitelist core-platform-api test-api engineGetParameter(Ljava/lang/String;)Ljava/lang/Object;
    .locals 1
...
.method protected final whitelist core-platform-api test-api engineInitSign(Ljava/security/PrivateKey;)V
    .locals 1
...
.method protected final whitelist core-platform-api test-api engineInitSign(Ljava/security/PrivateKey;Ljava/security/SecureRandom;)V
    .locals 4
    ...
    .end local p0    # "this":Landroid/security/keystore/AndroidKeyStoreSignatureSpiBase;
    ...
    .restart local p0    # "this":Landroid/security/keystore/AndroidKeyStoreSignatureSpiBase;
...
.method protected final whitelist core-platform-api test-api engineInitVerify(Ljava/security/PublicKey;)V
    .locals 4
...
.method protected final whitelist core-platform-api test-api engineSetParameter(Ljava/lang/String;Ljava/lang/Object;)V
    .locals 1
    .param p1, "param"    # Ljava/lang/String;
...
.method protected final whitelist core-platform-api test-api engineSign([BII)I
    .locals 1
    .param p1, "out"    # [B
...
.method protected final whitelist core-platform-api test-api engineSign()[B
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/security/SignatureException;
...
.method protected final whitelist core-platform-api test-api engineUpdate(B)V
    .locals 3
    .param p1, "b"    # B
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method protected final whitelist core-platform-api test-api engineUpdate(Ljava/nio/ByteBuffer;)V
    .locals 4
...
.method protected final whitelist core-platform-api test-api engineUpdate([BII)V
    .locals 4
    .param p1, "b"    # [B
    .param p2, "off"    # I
    .param p3, "len"    # I
...
.method protected final whitelist core-platform-api test-api engineVerify([B)Z
    .locals 7
...
.method protected final whitelist core-platform-api test-api engineVerify([BII)Z
    .locals 1
    .param p1, "sigBytes"    # [B
    .param p2, "offset"    # I
    .param p3, "len"    # I
...
.method protected final blacklist getKeyStore()Landroid/security/KeyStore;
    .locals 1
...
.method protected blacklist initKey(Landroid/security/keystore/AndroidKeyStoreKey;)V
    .locals 0
