...
# instance fields
.field private final greylist-max-o mDefaultKeySizeBits:I

.field protected greylist-max-o mKeySizeBits:I

.field private final greylist-max-o mKeyStore:Landroid/security/KeyStore;

.field private final greylist-max-o mKeymasterAlgorithm:I

.field private greylist-max-o mKeymasterBlockModes:[I

.field private final greylist-max-o mKeymasterDigest:I

.field private greylist-max-o mKeymasterDigests:[I

.field private greylist-max-o mKeymasterPaddings:[I
...
# direct methods
.method protected constructor greylist-max-o <init>(II)V
    .locals 1
...
.method protected constructor greylist-max-o <init>(III)V
    .locals 2
    .param p1, "keymasterAlgorithm"    # I
...
.method protected whitelist core-platform-api test-api engineGenerateKey()Ljavax/crypto/SecretKey;
    ...
    .end local p0    # "this":Landroid/security/keystore/AndroidKeyStoreKeyGeneratorSpi;
    throw v3

    .line 330
    .restart local v0    # "spec":Landroid/security/keystore/KeyGenParameterSpec;
    .restart local v1    # "args":Landroid/security/keymaster/KeymasterArguments;
    .restart local v8    # "resultingKeyCharacteristics":Landroid/security/keymaster/KeyCharacteristics;
    .restart local v10    # "additionalEntropy":[B
    .restart local v11    # "flags":I
    .restart local v12    # "keyAliasInKeystore":Ljava/lang/String;
    .restart local v13    # "success":Z
    .restart local p0    # "this":Landroid/security/keystore/AndroidKeyStoreKeyGeneratorSpi;
    :cond_3
...
.method protected whitelist core-platform-api test-api engineInit(Ljava/security/SecureRandom;)V
    .locals 3
