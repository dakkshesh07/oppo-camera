...
# virtual methods
.method public final whitelist test-api addPrinters(Ljava/util/List;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final whitelist test-api getPrinters()Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final whitelist test-api getTrackedPrinters()Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final whitelist test-api isDestroyed()Z
    .locals 1
...
.method public final whitelist test-api isPrinterDiscoveryStarted()Z
    .locals 1
...
.method public whitelist test-api onRequestCustomPrinterIcon(Landroid/print/PrinterId;Landroid/os/CancellationSignal;Landroid/printservice/CustomPrinterIconCallback;)V
    .locals 0
...
.method public abstract whitelist test-api onStartPrinterDiscovery(Ljava/util/List;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List<",
...
.method public abstract whitelist test-api onStartPrinterStateTracking(Landroid/print/PrinterId;)V
.end method

.method public abstract whitelist test-api onStopPrinterDiscovery()V
.end method

.method public abstract whitelist test-api onStopPrinterStateTracking(Landroid/print/PrinterId;)V
.end method

.method public abstract whitelist test-api onValidatePrinters(Ljava/util/List;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Ljava/util/List<",
...
.method public final whitelist test-api removePrinters(Ljava/util/List;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
