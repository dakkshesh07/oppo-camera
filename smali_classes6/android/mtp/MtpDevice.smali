...
.method public constructor whitelist test-api <init>(Landroid/hardware/usb/UsbDevice;)V
    .locals 1
...
.method public whitelist test-api deleteObject(I)Z
    .locals 1
...
.method public whitelist test-api getDeviceInfo()Landroid/mtp/MtpDeviceInfo;
    .locals 1
...
.method public whitelist test-api getDeviceName()Ljava/lang/String;
    .locals 1
...
.method public whitelist test-api getObject(II)[B
    .locals 2
    .param p1, "objectHandle"    # I
...
.method public whitelist test-api getObjectHandles(III)[I
    .locals 1
...
.method public whitelist test-api getObjectInfo(I)Landroid/mtp/MtpObjectInfo;
    .locals 1
    .param p1, "objectHandle"    # I
...
.method public whitelist test-api getParent(I)J
    .locals 2
    .param p1, "objectHandle"    # I
...
.method public whitelist test-api getPartialObject(IJJ[B)J
    .locals 2
    .param p1, "objectHandle"    # I
    .param p2, "offset"    # J
    .param p4, "size"    # J
...
.method public whitelist test-api getPartialObject64(IJJ[B)J
    .locals 2
    .param p1, "objectHandle"    # I
    .param p2, "offset"    # J
    .param p4, "size"    # J
...
.method public whitelist test-api getStorageId(I)J
    .locals 2
    .param p1, "objectHandle"    # I
...
.method public whitelist test-api getStorageIds()[I
    .locals 1
...
.method public whitelist test-api getStorageInfo(I)Landroid/mtp/MtpStorageInfo;
    .locals 1
    .param p1, "storageId"    # I
...
.method public whitelist test-api getThumbnail(I)[B
    .locals 1
    .param p1, "objectHandle"    # I
...
.method public whitelist test-api importFile(ILandroid/os/ParcelFileDescriptor;)Z
    .locals 1
    .param p1, "objectHandle"    # I
...
.method public whitelist test-api importFile(ILjava/lang/String;)Z
    .locals 1
    .param p1, "objectHandle"    # I
...
.method public whitelist test-api open(Landroid/hardware/usb/UsbDeviceConnection;)Z
    .locals 6
...
.method public whitelist test-api readEvent(Landroid/os/CancellationSignal;)Landroid/mtp/MtpEvent;
    .locals 3
...
.method public whitelist test-api sendObject(IJLandroid/os/ParcelFileDescriptor;)Z
    .locals 1
    .param p1, "objectHandle"    # I
    .param p2, "size"    # J
...
.method public whitelist test-api sendObjectInfo(Landroid/mtp/MtpObjectInfo;)Landroid/mtp/MtpObjectInfo;
    .locals 1
