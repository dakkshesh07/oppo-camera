...
# instance fields
.field public whitelist test-api arg1:I

.field public whitelist test-api arg2:I
...
.field public whitelist test-api obj:Ljava/lang/Object;

.field public whitelist test-api replyTo:Landroid/os/Messenger;

.field public whitelist test-api sendingUid:I

.field greylist target:Landroid/os/Handler;

.field public whitelist test-api what:I
...
.method public static whitelist test-api obtain()Landroid/os/Message;
    .locals 3
...
.method public static whitelist test-api obtain(Landroid/os/Handler;)Landroid/os/Message;
    .locals 1
...
.method public static whitelist test-api obtain(Landroid/os/Handler;I)Landroid/os/Message;
    .locals 1
    .param p0, "h"    # Landroid/os/Handler;
    .param p1, "what"    # I
...
.method public static whitelist test-api obtain(Landroid/os/Handler;III)Landroid/os/Message;
    .locals 1
    .param p0, "h"    # Landroid/os/Handler;
    .param p1, "what"    # I
    .param p2, "arg1"    # I
...
.method public static whitelist test-api obtain(Landroid/os/Handler;IIILjava/lang/Object;)Landroid/os/Message;
    .locals 1
    .param p0, "h"    # Landroid/os/Handler;
    .param p1, "what"    # I
    .param p2, "arg1"    # I
...
.method public static whitelist test-api obtain(Landroid/os/Handler;ILjava/lang/Object;)Landroid/os/Message;
    .locals 1
    .param p0, "h"    # Landroid/os/Handler;
    .param p1, "what"    # I
...
.method public static whitelist test-api obtain(Landroid/os/Handler;Ljava/lang/Runnable;)Landroid/os/Message;
    .locals 1
    .param p0, "h"    # Landroid/os/Handler;
...
.method public static whitelist test-api obtain(Landroid/os/Message;)Landroid/os/Message;
    .locals 3
...
# virtual methods
.method public whitelist test-api copyFrom(Landroid/os/Message;)V
    .locals 1
...
.method public whitelist test-api getCallback()Ljava/lang/Runnable;
    .locals 1
...
.method public whitelist test-api getData()Landroid/os/Bundle;
    .locals 1
...
.method public whitelist test-api getTarget()Landroid/os/Handler;
    .locals 1
...
.method public whitelist test-api getWhen()J
    .locals 2
...
.method public whitelist test-api isAsynchronous()Z
    .locals 1
...
.method public whitelist test-api peekData()Landroid/os/Bundle;
    .locals 1
...
.method public whitelist test-api sendToTarget()V
    .locals 1
...
.method public whitelist test-api setAsynchronous(Z)V
    .locals 1
    .param p1, "async"    # Z
...
.method public whitelist test-api setData(Landroid/os/Bundle;)V
    .locals 0
...
.method public whitelist test-api setTarget(Landroid/os/Handler;)V
    .locals 0
