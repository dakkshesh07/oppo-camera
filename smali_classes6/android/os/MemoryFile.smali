...
.method private static native greylist native_pin(Ljava/io/FileDescriptor;Z)Z
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
# virtual methods
.method public declared-synchronized whitelist test-api allowPurging(Z)Z
    .locals 3
...
.method public whitelist test-api isPurgingAllowed()Z
    .locals 1
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
...
.method public whitelist test-api readBytes([BIII)I
    .locals 1
    .param p1, "buffer"    # [B
...
.method public whitelist test-api writeBytes([BIII)V
    .locals 1
    .param p1, "buffer"    # [B
    .param p2, "srcOffset"    # I
    .param p3, "destOffset"    # I
