...
# static fields
.field public static final whitelist test-api PARAM_BAND_FREQ_RANGE:I = 0x4

.field public static final whitelist test-api PARAM_BAND_LEVEL:I = 0x2

.field public static final whitelist test-api PARAM_CENTER_FREQ:I = 0x3

.field public static final whitelist test-api PARAM_CURRENT_PRESET:I = 0x6

.field public static final whitelist test-api PARAM_GET_BAND:I = 0x5

.field public static final whitelist test-api PARAM_GET_NUM_OF_PRESETS:I = 0x7

.field public static final whitelist test-api PARAM_GET_PRESET_NAME:I = 0x8

.field public static final whitelist test-api PARAM_LEVEL_RANGE:I = 0x1

.field public static final whitelist test-api PARAM_NUM_BANDS:I = 0x0

.field private static final greylist-max-o PARAM_PROPERTIES:I = 0x9

.field public static final whitelist test-api PARAM_STRING_SIZE_MAX:I = 0x20
...
# virtual methods
.method public whitelist test-api getBand(I)S
    .locals 5
...
.method public whitelist test-api getBandFreqRange(S)[I
    .locals 4
    .param p1, "band"    # S
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist test-api getBandLevel(S)S
    .locals 5
    .param p1, "band"    # S
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist test-api getBandLevelRange()[S
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;,
...
.method public whitelist test-api getCenterFreq(S)I
    .locals 5
    .param p1, "band"    # S
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public whitelist test-api getCurrentPreset()S
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;,
...
.method public whitelist test-api getNumberOfBands()S
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;,
...
.method public whitelist test-api getNumberOfPresets()S
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;,
...
.method public whitelist test-api getPresetName(S)Ljava/lang/String;
    .locals 1
    .param p1, "preset"    # S
...
.method public whitelist test-api getProperties()Landroid/media/audiofx/Equalizer$Settings;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/IllegalStateException;,
...
.method public whitelist test-api setBandLevel(SS)V
    .locals 5
    .param p1, "band"    # S
    .param p2, "level"    # S
    .annotation system Ldalvik/annotation/Throws;
...
.method public whitelist test-api setParameterListener(Landroid/media/audiofx/Equalizer$OnParameterChangeListener;)V
    .locals 3
...
.method public whitelist test-api setProperties(Landroid/media/audiofx/Equalizer$Settings;)V
    .locals 7
...
.method public whitelist test-api usePreset(S)V
    .locals 1
    .param p1, "preset"    # S
    .annotation system Ldalvik/annotation/Throws;
        value = {
