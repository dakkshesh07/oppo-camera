...
# direct methods
.method public constructor greylist-max-o <init>(Landroid/content/Context;Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;Landroid/os/Handler;)V
    .locals 1
...
.method static synthetic blacklist access$200(Landroid/media/session/MediaSessionManager$SessionsChangedWrapper;)Landroid/media/session/IActiveSessionsListener$Stub;
    .locals 1
...
.method static synthetic blacklist access$300(Landroid/media/session/MediaSessionManager$SessionsChangedWrapper;)V
    .locals 0
    .param p0, "x0"    # Landroid/media/session/MediaSessionManager$SessionsChangedWrapper;
...
.method static synthetic blacklist access$400(Landroid/media/session/MediaSessionManager$SessionsChangedWrapper;)Landroid/os/Handler;
    .locals 1
    .param p0, "x0"    # Landroid/media/session/MediaSessionManager$SessionsChangedWrapper;
...
.method static synthetic blacklist access$500(Landroid/media/session/MediaSessionManager$SessionsChangedWrapper;)Landroid/content/Context;
    .locals 1
    .param p0, "x0"    # Landroid/media/session/MediaSessionManager$SessionsChangedWrapper;
...
.method static synthetic blacklist access$600(Landroid/media/session/MediaSessionManager$SessionsChangedWrapper;)Landroid/media/session/MediaSessionManager$OnActiveSessionsChangedListener;
    .locals 1
    .param p0, "x0"    # Landroid/media/session/MediaSessionManager$SessionsChangedWrapper;
