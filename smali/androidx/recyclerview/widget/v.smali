...
.method public constructor <init>()V
    ...
    .line 42
    new-instance v0, Landroidx/recyclerview/widget/v$1;

    invoke-direct {v0, p0}, Landroidx/recyclerview/widget/v$1;-><init>(Landroidx/recyclerview/widget/v;)V

    iput-object v0, p0, Landroidx/recyclerview/widget/v;->c:Landroidx/recyclerview/widget/RecyclerView$n;
...
.method private b()V
    ...
    iget-object v1, p0, Landroidx/recyclerview/widget/v;->c:Landroidx/recyclerview/widget/RecyclerView$n;
...
.method private b(Landroidx/recyclerview/widget/RecyclerView$i;II)Z
    ...
    .line 161
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/v;->c(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/RecyclerView$s;
    ...
    .line 166
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Landroidx/recyclerview/widget/v;->a(Landroidx/recyclerview/widget/RecyclerView$i;II)I
    ...
    .line 171
    :cond_2
    invoke-virtual {v0, p2}, Landroidx/recyclerview/widget/RecyclerView$s;->setTargetPosition(I)V
...
.method a()V
    ...
    .line 189
    :cond_1
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/v;->a(Landroidx/recyclerview/widget/RecyclerView$i;)Landroid/view/View;
    ...
    .line 193
    :cond_2
    invoke-virtual {p0, v0, v1}, Landroidx/recyclerview/widget/v;->a(Landroidx/recyclerview/widget/RecyclerView$i;Landroid/view/View;)[I
...
.method public a(II)Z
    ...
    .line 75
    :cond_2
    invoke-direct {p0, v0, p1, p2}, Landroidx/recyclerview/widget/v;->b(Landroidx/recyclerview/widget/RecyclerView$i;II)Z
...
.method protected b(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/m;
    ...
    .line 227
    :cond_0
    new-instance p1, Landroidx/recyclerview/widget/v$2;
    ...
    invoke-direct {p1, p0, v0}, Landroidx/recyclerview/widget/v$2;-><init>(Landroidx/recyclerview/widget/v;Landroid/content/Context;)V
...
.method protected c(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/RecyclerView$s;
    ...
    .line 209
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/v;->b(Landroidx/recyclerview/widget/RecyclerView$i;)Landroidx/recyclerview/widget/m;
