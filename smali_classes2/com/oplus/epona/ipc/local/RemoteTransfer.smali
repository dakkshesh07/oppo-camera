...
# static fields
.field private static volatile a:Lcom/oplus/epona/ipc/local/RemoteTransfer;
...
.field private b:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "Ljava/lang/String;",
            "Lcom/oplus/epona/IRemoteTransfer;",
            ">;"
        }
    .end annotation
.end field
...
.method private constructor <init>()V
    ...
    iput-object v0, p0, Lcom/oplus/epona/ipc/local/RemoteTransfer;->b:Ljava/util/Map;

    return-void
.end method

.method private static synthetic a(Lcom/oplus/epona/ITransferCallback;Lcom/oplus/epona/Response;)V
    .locals 1

    .line 71
    :try_start_0
    invoke-interface {p0, p1}, Lcom/oplus/epona/ITransferCallback;->a(Lcom/oplus/epona/Response;)V
    :try_end_0
...
.method public static b()Lcom/oplus/epona/ipc/local/RemoteTransfer;
    .locals 2

    .line 37
    sget-object v0, Lcom/oplus/epona/ipc/local/RemoteTransfer;->a:Lcom/oplus/epona/ipc/local/RemoteTransfer;
    ...
    .line 39
    :try_start_0
    sget-object v1, Lcom/oplus/epona/ipc/local/RemoteTransfer;->a:Lcom/oplus/epona/ipc/local/RemoteTransfer;
    ...
    sput-object v1, Lcom/oplus/epona/ipc/local/RemoteTransfer;->a:Lcom/oplus/epona/ipc/local/RemoteTransfer;
...
.method private synthetic b(Ljava/lang/String;)V
    ...
    .line 138
    iget-object v0, p0, Lcom/oplus/epona/ipc/local/RemoteTransfer;->b:Ljava/util/Map;

    invoke-interface {v0, p1}, Ljava/util/Map;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lcom/oplus/epona/IRemoteTransfer;
...
.method public static synthetic lambda$UKTrKmZo1ABsYJU7BZXBCWCjBig(Lcom/oplus/epona/ipc/local/RemoteTransfer;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/oplus/epona/ipc/local/RemoteTransfer;->b(Ljava/lang/String;)V

    return-void
.end method

.method public static synthetic lambda$WvF7xkLsrGpaSh59qKdG2kY6bjw(Lcom/oplus/epona/ITransferCallback;Lcom/oplus/epona/Response;)V
    .locals 0
...
# virtual methods
.method public a(Ljava/lang/String;)Lcom/oplus/epona/IRemoteTransfer;
    .locals 7

    .line 112
    invoke-direct {p0}, Lcom/oplus/epona/ipc/local/RemoteTransfer;->c()Z
    ...
    .line 135
    invoke-static {v1}, Lcom/oplus/epona/IRemoteTransfer$Stub;->a(Landroid/os/IBinder;)Lcom/oplus/epona/IRemoteTransfer;

    move-result-object v0

    .line 136
    iget-object v4, p0, Lcom/oplus/epona/ipc/local/RemoteTransfer;->b:Ljava/util/Map;

    invoke-interface {v4, p1, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 138
    :try_start_0
    new-instance v4, Lcom/oplus/epona/ipc/local/-$$Lambda$RemoteTransfer$UKTrKmZo1ABsYJU7BZXBCWCjBig;

    invoke-direct {v4, p0, p1}, Lcom/oplus/epona/ipc/local/-$$Lambda$RemoteTransfer$UKTrKmZo1ABsYJU7BZXBCWCjBig;-><init>(Lcom/oplus/epona/ipc/local/RemoteTransfer;Ljava/lang/String;)V
...
.method public a(Lcom/oplus/epona/Request;)Lcom/oplus/epona/Response;
    ...
    invoke-direct {p0, p1}, Lcom/oplus/epona/ipc/local/RemoteTransfer;->b(Lcom/oplus/epona/Request;)Z
...
.method public a(Lcom/oplus/epona/Request;Lcom/oplus/epona/ITransferCallback;)V
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    invoke-interface {p2, p1}, Lcom/oplus/epona/ITransferCallback;->a(Lcom/oplus/epona/Response;)V
    ...
    new-instance v0, Lcom/oplus/epona/ipc/local/-$$Lambda$RemoteTransfer$WvF7xkLsrGpaSh59qKdG2kY6bjw;

    invoke-direct {v0, p2}, Lcom/oplus/epona/ipc/local/-$$Lambda$RemoteTransfer$WvF7xkLsrGpaSh59qKdG2kY6bjw;-><init>(Lcom/oplus/epona/ITransferCallback;)V
